    ...
    <div className='container-fluid'>
        <Row>
                <div className='linkhead'>
                    <Link to ="/Bokking"><i className='fa fa-arrow-left'></i></Link>
                    <Link to="/Bokking">Booking Confirmation</Link>
                </div>
            </Row>
            <Row className='px-5'> 
...
const SubMid = () =>(
    <>
            <Row className='m-0 p-3 AwaitConfirmbox '>
                <Row className='px-5 my-2'>
                    <Col sm={6}><svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64">
...
Awaiting Confirmation</Col>
                    <Col sm={6} style={{textAlign:'right'}}>	&#8377;6459</Col>
                </Row>
                <Row className='px-4'>
