...
import './periodic.css';
//import './AddFastag.css';
//import './BookGarageA.css';
...
import Venue from '../src/Images/CarBrand/Models/2 Hyundai/Venue.jpeg';
import timepass from '../src/Images/Images/drawable-xxxhdpi/timepass.png';
    ...
    <div className='container-fluid px-5'>
        <Row>
                <div className='linkhead'>
                    <Link to ="/BkByAddvechile"><i className='fa fa-arrow-left'></i></Link>
                    <Link to="/BkByAddvechile">Booking Confirmation</Link>
                </div>
            </Row>
            <Row> 
...
const SubMid = () =>(
    <>
            <Row className='m-0 px-3  py-2 AwaitConfirmbox '>
                <Row className=' my-2'>
                    <Col sm={10}>
                    <Row> <Col sm={1} style={{padding:'10px'}}><svg xmlns="http://www.w3.org/2000/svg" width="50.999" height="50" viewBox="0 0 63.999 64">
...
<Col sm={11} className='px-3 py-2'><p style={{fontSize:'20px',color:'#53BD8C',marginBottom:'0px'}}>Booking Accepted</p>
<p style={{fontSize:'12px',color:'#2650D8'}}>Booking ID: MG1234567890 </p></Col></Row>
                   
                    
</Col>
                    <Col sm={2} className=' py-2' >	<p style={{textAlign:'right',color:'#132337' ,fontSize:'20px',fontWeight:'bold',marginBottom:'0px'}}>&#8377;6459</p>
                    <p style={{paddingLeft:'30px',color:'red',fontSize:'12px',marginBottom:'0px'}}>Pay Later</p></Col>
                </Row>
                <Row className='px-4'>
                ...
                <Row className=' m-0'>
                    ...
                    <p style={{fontSize:'14px',color:'#5D6186',marginBottom:'0px'}}>Mahindra First Choice</p>
...
<p  style={{textDecoration:'underline',fontSize:'10px',paddingRight:'3px'}}>Download QR</p>
  ...
  <g id="Group_30180" data-name="Group 30180" transform="translate(0)">
    ...
    <p className='px-2' ><button style={{width:'200px', height:'40px',color:'#fff',backgroundColor:'#2650D8',borderRadius:'10px',textAlign:'center',border:'none'}}>Track Booking Status</button></p>
