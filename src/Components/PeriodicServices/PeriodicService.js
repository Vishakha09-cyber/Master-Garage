...
const SubLast = () => (
    <>
        <div class="boxlast py-3 px-2">
        <form>
            <input className='addvechicleInput' type="text" placeholder="Example - MH 01 AB 1234" name="add vechicle" />
            <Link to ="/PeriodicADDvechicle"><button className='addvechicle'>Add Vechicle</button></Link>
        </form>
        ...
        <Row className='addbg mx-3 my-3'>
        <Col sm={6}><div><img src={qr} style={{height:'45px',width:'45px;',marginBottom:'20px'}}></img>
        <h5 className='poppins20B'>Baleno</h5>
        <h6 style={{color:'grey',fontSize:'12px  '}}>MH 01 AB 3827</h6></div></Col>
        ...
        <Row className='addbg mx-3 my-3'>
        <Col sm={6}><div><img src={qr} style={{height:'45px',width:'45px;',marginBottom:'20px'}}></img>
        <h5 className='poppins20B'>i10</h5>
        <h6 style={{color:'grey',fontSize:'12px  '}}>MH 01 AB 3827</h6></div></Col>
