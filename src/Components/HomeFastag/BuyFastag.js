...
Apply Coupons</p></Col>
                ...
                <Row className='BottomBG my-3 px-2 py-3'>
                        <Col sm={1} className='py-2 px-1'><img src={CardPay} style={{width:'30px',height:'30px'}}></img></Col>
                        <Col sm={3} ><p style={{fontSize:'12px',fontWeight:'200',marginBottom:'0px'}}>Total Payment</p><p style={{fontSize:'20px',fontWeight:'bold',marginBottom:'0px'}}> ₹438</p></Col>
                        <Col sm={8}>
