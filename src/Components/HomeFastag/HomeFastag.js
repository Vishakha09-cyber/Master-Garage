            ...
            <Row>
                <Col sm={6}>
                    ...
                    <ul className='HomeFastaglist'>
                        <li className='py-5'><svg xmlns="http://www.w3.org/2000/svg" width="94.107" height="69.467" viewBox="0 0 94.107 69.467">
...
<p className='poppins18 py-3'>BUY</p>
                        ...
                        <li  className='py-5'><svg xmlns="http://www.w3.org/2000/svg" width="73" height="73" viewBox="0 0 73 73">
  <g id="Group_27220" data-name="Group 27220" transform="translate(-364 -307)">
    ...
    <g id="Ellipse_2145" data-name="Ellipse 2145" transform="translate(364 307)" fill="none" stroke="#00155a" stroke-width="5">
      ...
      <circle cx="36.5" cy="36.5" r="34" fill="none"/>
                        ...
                        <li className='py-5'><svg xmlns="http://www.w3.org/2000/svg" width="77.3" height="72.638" viewBox="0 0 77.3 72.638">
...
<p className='poppins18 py-3'>ACTIVATE</p></li>
                        <li  className='py-5'><svg xmlns="http://www.w3.org/2000/svg" width="56.46" height="74.128" viewBox="0 0 56.46 74.128">
...
<p className='poppins18 py-3'>PASSBOOK</p></li>
                    </ul>
                </Col>
                <Col sm={6}>
