      ...
      <Card className="card12 d-flex rounded shadow">
               <CardBody >
                  <ul className="leftmenu">
                     <li><Link exact className="supportprofile1" to="/"><svg xmlns="http://www.w3.org/2000/svg" width="34" height="34.539" viewBox="0 0 34 34.539">
                     ...
                     <li>
                       <Link className="supportprofile1" to="/mygarage"> <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                       ...
                       <li><Link className="supportprofile1" to="/mgcoin">
                        ...
                        <li>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="19.833" height="16.554" viewBox="0 0 19.833 16.554">
